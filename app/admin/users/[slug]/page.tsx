...
const AccountDetailPage = () => {
  const accountData = {
    id: 2,
    email: "D1doanquang@gmail.com",
    enabled: true,
    lockedReason: "",
    lockedAt: "2025-12-26T16:50:48.436839",
    roles: [{ roleName: "USER", description: "Người dùng mặc định" }],
    userProfile: {
      profileId: 1,
      username: "chatutay",
      mobileNumber: "0363636369",
      gender: "con cho",
      birthDate: null,
      addressResponse: [
        {
          ...
          province: "Hà Nội",
          postalCode: "36",
          additionalInfo: "uoc duoc tang bo pc tu cha",
          isDefault: true,
          type: "WORK",
          label: "ngc",
          shortAddress: "Yen Lang, quận Đống Đa, Hà Nội",
          fullAddress:
            "120 Yên Lãng, phường Thịnh Quang, quận Đống Đa, Hà Nội (Tay Bo Cha)",
          createdAt: "2025-12-25T04:03:42",
          updatedAt: null,
        },
      ],
      cartResponse: {
        ...
        items: [
          {
            cartItemId: 7,
            productId: 1,
            productName: "Murano Cactus Mini",
            quantity: 2,
            unitPrice: 90000,
            totalPrice: 180000,
          },
          {
            cartItemId: 9,
            productId: 2,
            productName: "Murano Cactus Mini 1",
            quantity: 8,
            unitPrice: 90000,
            totalPrice: 720000,
          },
          {
            cartItemId: 11,
            productId: 3,
            productName: "Murano Cactus Mini 11",
            quantity: 2,
            unitPrice: 90000,
            totalPrice: 180000,
          },
          {
            cartItemId: 12,
            productId: 4,
            productName: "Murano Cactus Mini 111",
            quantity: 9,
            unitPrice: 90000,
            totalPrice: 810000,
          },
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className=" bg-linear-to-br from-yellow-100 to-yellow-50 p-4 rounded-xl">
                  ...
                  <p className="text-gray-800 text-xs">
                    {formatDate(accountData.lockedAt)}
                  </p>
                </div>
                ...
                <div key={address.addressId} className="space-y-3">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                    ...
                    <div className="text-xs text-gray-500 pt-2 border-t">
                      Tạo: {formatDate(address.createdAt)}
                    </div>
                  </div>
                </div>
              ))}
