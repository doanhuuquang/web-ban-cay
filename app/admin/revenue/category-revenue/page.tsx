...
function OrderTable({ sort, isloading, currentPageRows }: { sort: string, isloading: boolean, currentPageRows: categoryRevenue[] }) {
                        ...
                        {(sort === "ASC" ? currentPageRows : currentPageRows.slice().reverse()).map((row, index) => {
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3">{formatMoney(row.revenueCategory)}</td>
                                    <td className="px-4 py-3">{row.totalProductsSold}</td>
                                    <td className="px-4 py-3">{row.totalOrders}</td>
                                    <td className="px-4 py-3">{formatMoney(row.averageOrderValue)}</td>
