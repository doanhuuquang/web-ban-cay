...
function OrderTable({ sort, isloading, currentPageRows }: { sort: string, isloading: boolean, currentPageRows: quarterlyRevenue[] }) {
                        ...
                        {(sort === "ASC" ? currentPageRows : currentPageRows.slice().reverse()).map((row, index) => {
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3">{formatMoney(row.revenueQuarter)}</td>
